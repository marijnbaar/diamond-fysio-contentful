...
const getComponentsData = async (components, preview, locale) => {
  const result = components
    ? (
        ...
        // Filter out null/undefined components and components that failed due to asset errors
        if (!component) return false;
        // If component has an image field that is explicitly null due to error, keep it but log
