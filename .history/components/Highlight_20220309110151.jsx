  ...
  return (
    <div className="bg-gray-50 py-16 lg:py-24">
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-52 mb-0">
        <div className="relative py-24 px-8 bg-gradient-to-l from-teal-500 to-cyan-600 rounded-xl shadow-2xl overflow-hidden lg:px-16 lg:grid lg:grid-cols-2 lg:gap-x-8">
          <div className="absolute inset-0 filter saturate-0 mix-blend-multiply">
            <img
