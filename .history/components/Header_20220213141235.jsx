...
export default function Header() {
  return (
    <div className="mt-[92px] relative bg-gradient-to-r from-teal-200 to-cyan-600 overflow-hidden">
      <div className="max-w-7xl mx-auto">
        <div className="relative z-10 pb-8 bg-gradient-to-r from-teal-100 to-cyan-600 sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:h-[40vw] lg:pb-28 xl:pb-32">
