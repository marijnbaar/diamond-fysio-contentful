  ...
  <div className="pricing-box max-w-lg mx-auto rounded-lg shadow-lg overflow-hidden lg:max-w-none lg:flex">
    <div className="bg-white dark:bg-gray-800 px-6 py-8 lg:flex-shrink-1 lg:p-12">
      ...
      <p className="mt-6 text-base leading-6 text-gray-500 dark:text-gray-200">
        ...
        and pick-up service, nothing more. We don&#x27;t charge commission or monthly fees, keep all
        your margin.
      </p>
      <div className="mt-8">
        ...
        <ul className="mt-8 lg:grid lg:grid-cols-2 lg:col-gap-8 lg:row-gap-5">
          ...
          <li className="flex items-start lg:col-span-1">
            ...
            <p className="ml-3 text-sm leading-5 text-gray-700 dark:text-gray-200">Best ranking</p>
          </li>
          <li className="flex items-start lg:col-span-1">
            <div className="flex-shrink-0">
              <svg
            ...
            <p className="ml-3 text-sm leading-5 text-gray-700 dark:text-gray-200">Prenium svg</p>
          </li>
          <li className="flex items-start lg:col-span-1">
            <div className="flex-shrink-0">
              <svg
            ...
            <p className="ml-3 text-sm leading-5 text-gray-700 dark:text-gray-200">My wife</p>
          </li>
        </ul>
      </div>
      <div className="mt-8">
