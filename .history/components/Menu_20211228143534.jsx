...
export default function Menu() {
  return (
    <Popover className="z-30 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex sticky top-0 justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
