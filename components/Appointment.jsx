              ...
              <div className="relative py-11 px-8 bg-white rounded-xl shadow-2xl overflow-hidden lg:px-16 lg:grid lg:grid-cols-1 lg:gap-x-8">
                <blockquote className="mt-2 text-gray-400">
                  <p className="text-xl font-medium sm:text-2xl">
                    Let op: helaas is SpotonMedics, de site waarmee online afspraken bij onze
                    praktijk kunnen worden ingepland, op dit moment niet bereikbaar. Voor het maken
                    van een afspraak kun je contact opnemen met de praktijk.
                  </p>
                </blockquote>
