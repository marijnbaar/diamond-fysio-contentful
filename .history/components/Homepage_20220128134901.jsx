            ...
            <div className="relative mx-auto max-w-md px-4 py-12 sm:max-w-7xl sm:px-6 sm:py-20 md:py-28 lg:px-8 lg:py-32">
              <div className="md:ml-auto md:w-1/2 md:pl-10">
                ...
                <p className="mt-3 text-lg text-gray-300">
                  Veel van onze therapeuten hebben een dans-achtergrond, en helpen je graag bij het aanleren van nieuwe bewegingspatronen. Ook kunnen klachten verminderen als je andere spiergroepen traint om sterker te worden.
                </p>
                <div className="mt-8">
