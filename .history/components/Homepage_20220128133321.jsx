  ...
  return (
    <div className="bg-white">
      <div className="relative overflow-hidden">
        ...
        <footer className="bg-gradient-to-r from-teal-500 to-cyan-600" aria-labelledby="footer-heading">
          ...
          <div className="max-w-md mx-auto pt-12 px-4 sm:max-w-7xl sm:px-6 lg:pt-16 lg:px-8">
            <div className="xl:grid xl:grid-cols-3 xl:gap-8">
              <div className="space-y-8 xl:col-span-1">
                <img
                  className="h-10"
                  src="https://fysiodiamondfactory.nl/wp-content/uploads/2021/05/witgrijs-letters-logo-alpha-300x300.png"
                  alt="Diamond fysio"
                />
