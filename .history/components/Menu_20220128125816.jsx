...
const specialisaties = [
  ...
  },
  {
    ...
    description: 'Behandel klachten met mobilisatie en manipulatie',
    href: '#',
    icon: CursorClickIcon,
  },
  { name: 'Dry needle', description: "Behandeling myofasciale pijn met een accupuntuurnaald", href: '#', icon: ShieldCheckIcon },
  {
    name: 'Shockwave',
