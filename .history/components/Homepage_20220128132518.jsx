            ...
            <div className="relative">
              <div className="text-center mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl">
                ...
                <p className="mt-5 mx-auto max-w-prose text-xl text-gray-500">
                  Als praktijk hebben we therapeuten met uiteenlopende specialicaties, die nauw met elkaar samenwerken. Van pilates tot vocal massages, in een moderne praktijk aan een gezellige gracht in Amsterdam.
                </p>
              </div>
