            ...
            {aboutFeatureCollection &&
              aboutFeatureCollection.items.map((feature) => (
                <div key={feature.title} className="relative">
                  <dt>
                    <p className="text-center lg:ml-24 text-lg leading-6 font-medium text-gray-900">
                      {feature.title}
                    </p>
                  </dt>
                  <dd className="mt-2 text-center lg:ml-24 text-base text-gray-500">
                    {feature.description}
                  </dd>
                  <div className="m-auto lg:w-96 lg:ml-36">
                    {feature.button && (
                      <div className="my-2">
                        <Button
