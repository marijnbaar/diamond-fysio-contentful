        ...
        <main>
          <div className="relative bg-gray-50 pt-16 sm:pt-24 lg:pt-10">
            <div className="mx-auto max-w-md px-4 text-center sm:px-6 sm:max-w-3xl lg:px-8 lg:max-w-7xl">
              <div>
                {/* {data.title.hasOwnProperty('json')
                  ? setRichtTextToReactComponents(data.title.json)
                  : null} */}
              ...
              <div className="mt-12 -mb-1 sm:-mb-24 lg:-mb-80">
                <img
                  ...
                  src="https://fysiodiamondfactory.nl/wp-content/uploads/2021/03/cropped-DSC_0233-scaled-1.jpg"
                  alt=""
                />
              </div>
            </div>
            ...
            <div className="relative">
              <div className="text-center mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl">
                ...
                <p className="mt-5 mx-auto max-w-prose text-xl text-gray-500">
                  Als praktijk hebben we therapeuten met uiteenlopende specialicaties die nauw met
                  elkaar samenwerken. Van pilates tot vocal massages, in een moderne praktijk in
                  Amsterdam.
                </p>
              </div>
          ...
          <div className="relative bg-gray-900">
            <div className="relative h-56 bg-indigo-600 sm:h-72 md:absolute md:left-0 md:h-full md:w-1/2">
              <img
                ...
                src="https://leilaspilates.nl/wp-content/uploads/2021/10/0441082c70da3cad94a060b55f44b014.jpg"
                alt=""
              />
              <div
                aria-hidden="true"
          ...
          <div className="max-w-md mx-auto pt-12 px-4 sm:max-w-7xl sm:px-6 lg:pt-16 lg:px-8">
            <div className="xl:grid xl:grid-cols-3 xl:gap-8">
              <div className="space-y-8 xl:col-span-1">
                <img
                  className="h-14"
                  src="https://fysiodiamondfactory.nl/wp-content/uploads/2021/05/cirkel-vette-letters-25-cm.png"
                  alt="Diamond fysio"
                />
                <p className="text-gray-500 text-base">
                  Onze therapeuten helpen je bij klachten die je hinderen bij dagelijkse
                  activiteiten.
                </p>
