  ...
  theme: {
    ...
    extend: {
      backgroundImage: () => ({
        ...
        "landing-background":
          "linear-gradient(rgba(0,0,0, 0.15), rgba(0,0,0, 0.15)), url(https://images.pexels.com/photos/5473182/pexels-photo-5473182.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260)",
        "pointed-background":
