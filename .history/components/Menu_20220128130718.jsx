...
import { ChevronDownIcon, FingerPrintIcon, HandIcon, StatusOnlineIcon, UsersIcon } from '@heroicons/react/solid'
...
const specialisaties = [
  ...
  { name: 'Dry needling', description: "Behandeling myofasciale pijn met een accupunctuurnaald", href: '#', icon: ShieldCheckIcon },
  {
    name: 'Shockwave',
